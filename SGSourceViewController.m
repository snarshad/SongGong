...
@interface SGSourceViewController ()
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //  All custom subclasses should override this and:
        //      (1) Create the source (and assign self.source to it)
        //      (2) Set the source's delegate to self
        //        source = [[SGSource alloc] init];
...
- (void)viewDidLoad
{
    ...
    [self updateUIForItem:source.currentItem];
...
- (void)updateUIForItem:(id<SGMediaItem>)item
{
    if (!item)
    {
        ...
        playlistNameLabel.text = source.currentPlaylist.title;
        [self.view setNeedsDisplay];
        //myPlaylistsLabel.text = source;
    }
